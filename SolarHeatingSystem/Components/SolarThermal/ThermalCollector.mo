...
model ThermalCollector "Model of a solar thermal collector"
  ...
  Modelica.Blocks.Sources.RealExpression QCon[nEle](y=-A/nEle .* (C_1 .* (vol.T .-
    ...
    preSumCon.port.T))) "Convective heat flow rate"
...
protected
  Modelica.Blocks.Interfaces.RealInput GSC_internal "Shading coefficient";
...
public
  Modelica.Blocks.Interfaces.RealInput IrrDir annotation (
      Placement(transformation(
        ...
        rotation=270,
        origin={-37,77})));
  Modelica.Blocks.Interfaces.RealInput IrrDif annotation (
      Placement(transformation(
        extent={{-20,-20},{20,20}},
        rotation=270,
        ...
        rotation=270,
        origin={-3,77})));
  Modelica.Blocks.Interfaces.RealInput inc annotation (
      Placement(transformation(
        extent={{-20,-20},{20,20}},
        rotation=270,
